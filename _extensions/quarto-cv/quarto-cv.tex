...
% Define a short line (60% of text width)
\newcommand{\sectionline}{\vspace{-1em}\centering\noindent\rule{0.6\textwidth}{0.4pt}}

\titleformat{\section}
  {\centering\Large\bfseries} % Formatting (centered, large, bold)
  {} % No numbering
  {0pt} % No spacing before title
  {} % No extra code before title
  [\sectionline] % Short horizontal rule under title

\titleformat{\subsection}
  {\centering\large\scshape} % Formatting (centered, small caps)
  {} % No numbering
  {0pt} % No spacing before title
  {} % No extra code before title
  [\sectionline] % Short horizontal rule under title
